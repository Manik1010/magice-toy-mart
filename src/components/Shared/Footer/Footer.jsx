        ...
        <div>
            <footer className="footer p-10 bg-base-200 text-base-content">
                <div>
                    ...
                    <a className="link link-hover font-semibold">C</a>
                    <a className="link link-hover font-semibold">C++</a>
                    <a className="link link-hover font-semibold">Java</a>
                    <a className="link link-hover font-semibold">Python</a>
                </div>
                <div>
                    <span className="footer-title">Company</span>
                    <a className="link link-hover font-semibold">About us</a>
                    <a className="link link-hover font-semibold">Contact</a>
                    <a className="link link-hover font-semibold">Toys</a>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p><span className="font-bold">Magice Toys Mart.</span> <br />Providing reliable tech since 2022</p>
                </div>
